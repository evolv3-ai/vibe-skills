...
- Provider skills (`oci`, `hetzner`, `contabo`, `digital-ocean`, `vultr`, `linode`) for provider-specific VM setup.
- `admin` for local Docker/CLI support when coordinating from WSL.
