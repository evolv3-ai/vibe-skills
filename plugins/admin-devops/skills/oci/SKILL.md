...
- CLI install/config/capacity/networking details: `references/`
...
- [Installation Guide](references/INSTALL.md) - Install OCI CLI on any OS
- [Configuration Guide](references/CONFIG.md) - Set up OCI credentials
- [Capacity Guide](references/CAPACITY.md) - Handling capacity issues
- [Networking Guide](references/NETWORKING.md) - VCN, subnets, security lists
