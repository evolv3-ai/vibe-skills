...
_Consolidated from `skills/admin-devops (linode)` on 2026-02-02_
...
# After provisioning
log_admin_event "Provisioned Linode $LINODE_ID in $LINODE_REGION ($LINODE_TYPE)" "OK"

# After destroying
log_admin_event "Deleted Linode $LINODE_ID" "OK"
...
### linode: references/OPERATIONS.md
